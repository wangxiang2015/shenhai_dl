...
# 15 second model
class CTN(nn.Module):
    def __init__(self, d_model, nhead, d_ff, num_layers, dropout_rate, deepfeat_sz, nb_feats, nb_demo, nb_classes, **kwargs):
        ...
        self.fc2 = nn.Linear(deepfeat_sz+nb_feats+nb_demo, nb_classes)
    ...
    def forward(self, x, wide_feats):
        ...
        #out_sigmoid = self._new_sigmoid(out)
        return out                
